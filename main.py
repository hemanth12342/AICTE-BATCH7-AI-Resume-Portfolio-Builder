...
# ---------------------------
GROQ_API_KEY = "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"
...
if st.button("Generate Resume & Portfolio"):
    ...
    st.session_state.portfolio = generate_portfolio(name, skills, projects, experience, education)
